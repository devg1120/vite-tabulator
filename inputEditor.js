...
export function inputEditorSetTable(_table) {
   table = _table
}

export function inputEditor( cell, onRendered, success, cancel, editorParams) {
 ...
 var cellValue = cell.getValue();
  ...
  function successFunc() {
    ...
    //success(editor.value);
                ...
                if(((cellValue === null || typeof cellValue === "undefined") && editor.value !== "") || editor.value !== cellValue){
                        if(success(editor.value)){
                                cellValue = editor.value; //persist value if successfully validated incase editor is used as header filter
                        }
                }else{
                        cancel();
                }
